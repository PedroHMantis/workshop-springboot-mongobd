package com.pedromantis.workshopmongo.config;

import com.pedromantis.workshopmongo.domain.Post;
import com.pedromantis.workshopmongo.domain.User;
import com.pedromantis.workshopmongo.dto.AuthorDTO;
import com.pedromantis.workshopmongo.dto.CommentDTO;
...
public class Intantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, sdf.parse("27/09/2025"),"Partiu Viagem","Vou viajar para São Paulo. Abraços!", new AuthorDTO(maria));
        Post post2 = new Post(null, sdf.parse("27/10/2026"),"Bom dia","Acordei feliz hoje!", new AuthorDTO(maria));
